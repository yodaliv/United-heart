...
const BlueButton = ({ large, small, children, ...other }) => {
  const RenderButton = withStyles({
    root: {
      ...
      fontSize: '16px',
      fontWeight: 600,
      padding: large ? '11px 35px 10px 36px' : small ? '0 30px' : '7px 35px 6px 36px',
...
export { BlueButton, DarkGreenButton, GrayButton, RedButton, BlueOutlineButton, GrayOutlineButton, ActionButton };
